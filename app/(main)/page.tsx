      ...
      <div className='flex flex-col items-center text-center space-y-10 py-10'>
        <div className='space-y-4 max-w-3xl'>
          ...
          <p className='text-xl text-muted-foreground'>
            Polly is a modern polling platform that makes it simple to create
            polls, share them with QR codes, and analyze results in real-time.
          </p>
        </div>
        ...
        <div className='grid gap-8 md:grid-cols-3 max-w-5xl mt-16'>
          <div className='flex flex-col items-center space-y-2 p-4'>
            ...
            <p className='text-muted-foreground text-center'>
              ...
              descriptions and customize settings.
            </p>
          </div>
          ...
          <div className='flex flex-col items-center space-y-2 p-4'>
            ...
            <p className='text-muted-foreground text-center'>
              Share polls via links or QR codes. Perfect for events, classrooms,
              or social media.
            </p>
          </div>
          ...
          <div className='flex flex-col items-center space-y-2 p-4'>
            ...
            <p className='text-muted-foreground text-center'>
              View real-time results with beautiful visualizations. Track votes
              and analyze trends.
            </p>
          </div>
        </div>
